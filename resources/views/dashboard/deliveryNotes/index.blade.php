...
@section('content')
    <div class="mt-2">
        <span class="h2 d-inline-block mt-1">
            <b>{{__('crud.deliveryNotes.title')}}</b><span class="text-muted">({{$total}})</span>
        </span>
        <a class="btn btn-primary d-inline-block ms-3 align-top" href="{{route('dashboard.deliveryNotes.create')}}">
            <span class="px-4"><i class="bx bx-plus mt-1"></i>{{__('global.create')}} {{ __('crud.deliveryNotes.title_singular')}}</span>
        </a>
    </div>

    <div class="mt-4">
        <table class="table table-borderless table-responsive table-hover ajaxTable datatable datatable-DeliveryNotes mt-5 w-100">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('dashboard.deliveryNotes.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                ajax: {
                    url: "{{ route('dashboard.deliveryNotes.index') }}",
                    data: function(data) {
            ...
            drawDataTable('.datatable-DeliveryNotes', dtOverrideGlobals, true);
