                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-4 col-lg-3 text-center">
                            <img src="{{$user->profile_img}}" alt="" class="rounded border" width="100px" height="100px">
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <span class="text-muted"><b>{{ now()->startOfWeek()->addDays(array_search($wday, $weekdays))->format('jS M, Y') }}</b></span>
                                        </div>
                                    </div>
                                </div>
                                @foreach ($events[$wday] as $event)
                                    @if(get_class($event) == 'App\Models\Leave')
                                        <div class="card border-0 rounded-0 card-event" style="{{$event->leaveType->styles}}" data-bs-toggle="tooltip" data-bs-title="{{$event->leaveType->name}}" data-bs-placement="top">
                                            <div class="card-body p-2">
                                                <div class="row p-0">
                                                    ...
                                                    <div class="col-md-9">
                                                        <i class='bx bxs-plane-take-off me-2 align-middle' style="font-size: 25px;"></i> <span>{{$event->user->name}}</span>
                                                    </div>
                                                </div>
                                    ...
                                    @else
                                        <a class="card border-0 rounded-0 card-event bg-primary text-white text-decoration-none" href="{{route('dashboard.tasks.show', $event->id)}}">
                                            <div class="card-body p-2">
                                                <div class="row p-0">
                                                    <div class="col-md-3">
                                                        Todo el dia
                                                    ...
                                                    <div class="col-md-9">
                                                        <i class='bx bx-list-ul me-2 align-middle' style="font-size: 25px;"></i> <span>{{$event->title}}</span>
                                                    </div>
                                                </div>
                                ...
                                <tbody>
                                    @foreach ($tasks as $task)
                                        <tr class="table-entry align-middle border-bottom">
                                            ...
                                            <td>
                                                <span class="badge {{ $task->status->badge }}">{{$task->status->title}}</span>
                                            </td>
