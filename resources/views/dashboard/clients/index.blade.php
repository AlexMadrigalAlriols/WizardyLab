            ...
            <tbody>
                @foreach ($clients as $client)
                    <tr class="table-entry align-middle border-bottom">
                        ...
                        <td><a href="{{route('dashboard.clients.show', $client->id)}}" class="text-decoration-none"><b>{{ $client->name }}</b></a></td>
                        <td>{{$client->email}}</td>
                        <td>{{$client->phone}}</td>
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a class="dropdown-item" href="{{route('dashboard.clients.show', $client->id)}}"><i class='bx bx-show' ></i> View</a></li>
                    ...
                    <td colspan="9" class="py-4 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted">
                                {{ count($clients) }} to {{$pagination['take'] ?? count($clients)}} items of <b>{{ $total }}</b>
                                @if(request('page') != 'all')
                                    <span class="ms-4">
