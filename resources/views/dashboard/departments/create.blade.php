    ...
    <div class="col-md-8 col-sm-12">
        <div class="mt-1">
            <span class="h2 d-inline-block mt-1">
                <b>{{__("global.create")}} {{__("crud.departments.title_singular")}}</b>
            </span>
        </div>
        <form action="{{route('dashboard.departments.store')}}" method="POST" class="mt-2 pb-3">
            ...
            <div class="row mt-4">
                <div class="col-md-12 text-end">
                    ...
                    <button class="btn btn-primary ms-2" id="submitBtn" disabled><span class="px-5">{{__("global.save")}} {{__("crud.departments.title_singular")}}</span></button>
                </div>
            </div>
        </form>
    </div>
