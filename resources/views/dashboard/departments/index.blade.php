...
@section('content')
    ...
    <div class="mt-4">
        <table class="table table-borderless table-responsive table-hover ajaxTable datatable datatable-Departments mt-5 w-100">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('dashboard.departments.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                ajax: {
                    url: "{{ route('dashboard.departments.index') }}",
                    data: function(data) {
            ...
            drawDataTable('.datatable-Departments', dtOverrideGlobals, true);
