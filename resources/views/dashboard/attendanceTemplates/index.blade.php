...
@section('content')
    ...
    <div class="mt-4">
        <table class="table table-borderless table-responsive table-hover ajaxTable datatable datatable-AttendanceTemplates mt-5 w-100">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('dashboard.attendanceTemplates.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                ajax: {
                    url: "{{ route('dashboard.attendanceTemplates.index') }}",
                    data: function(data) {
            ...
            drawDataTable('.datatable-AttendanceTemplates', dtOverrideGlobals, true);
