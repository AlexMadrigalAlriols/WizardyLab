...
<div class="row">
    <div class="col-md-10">
        <div class="form-floating mt-3">
            <select class="form-select select2" id="users_id" name="users_id">
...
<div class="row">
    <div class="col-md-7">
        <div class="form-floating mt-3">
            <select class="form-select select2" id="inventories_id" name="inventories_id">
              @foreach ($inventories as $item)
                <option value="{{$item->id}}"{{($assignment->inventories_id == $item->id || old('project') == $item->id) ? 'selected' : ''}}>{{ $item->name }} - {{ $item->reference }}</option>
              @endforeach
            </select>
    ...
    <div class="col-md-3">
        <div class="form-floating mt-3">
            <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Quantity" value="{{ old('quantity') ?? $assignment->quantity }}">
