...
<head>
    ...
    <link rel="alternate" hreflang="es" href="https://wizardylab.com/erp/es">
    <link rel="alternate" hreflang="en" href="https://wizardylab.com/erp//en">
    ...
    <meta property="og:title" content="Wizardylab - ERP">
    ...
    <meta name="twitter:title" content="Wizardylab - ERP">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @foreach ($langList as $langl)
                            <li><a class="dropdown-item text-capitalize" href="{{route('landing.erp', $langl)}}"><span class="fi fi-{{$langl == "en"?"us":$langl}}"></span> {{$langl}}</a></li>
                        @endforeach
                                ...
                                <div class="single-pricing">
                                    <div    >
                                        <div class="price-head">
                                            ...
                                            <span class="h1">28,25€</span><br>
                                            <span>/{{trans('plans.monthly')}}</span>
                                        </div>
                                        <ul class="ps-0">
                                            <li>{!! trans('plans.employee_accounts', ['count' => 40]) !!}</li>
